...
import { Achievement, computeAchievements, pointsToNextTier } from "@/lib/rank-tier";
...
export default async function PlayerProfilePage({
  ...
  const achievementPredicate = (a: Achievement, b: Achievement): Number => {return 1;}
  const achievements = [...computeAchievements(careerStats), ...matchAchievements].sort((a, b) => {});
