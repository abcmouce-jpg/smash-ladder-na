...
const nextConfig: NextConfig = {
  ...
  // The sets feed moved to /live, and the Board was renamed to /friendlies —
  // permanent so existing links (Discord posts, bookmarks, search results) keep
  // resolving instead of 404ing.
  async redirects() {
    return [
      { source: "/sets", destination: "/live", permanent: true },
      { source: "/board", destination: "/friendlies", permanent: true },
    ];
  },
  async headers() {
